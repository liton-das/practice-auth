...
const items = [
  {
    ...
    children: [
      { 
        key: '1', 
        label: <NavLink to={'#'} className={'text-[14px] '}>All Products</NavLink> 
      },
      { 
        key: '2', 
        label: <NavLink to={'#'} className={'text-[14px] '}>All Category</NavLink>
      },
      { 
        key: '3', 
      ...
      { 
        key: '4', 
        label: <NavLink to={'#'} className={'text-[14px] '}>Add Category</NavLink>
      },
    ],
  }
];
